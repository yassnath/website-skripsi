...
export default function InvoicePreviewLayer() {
  ...
  const handleSendToEmail = async () => {
    ...
    setSending(true);
    try {
      const res = await api.get(`/invoices/${invoice.id}/pdf-link`);
      ...
      alert("Gagal mengirim email. Pastikan endpoint pdf-link berjalan.");
    } finally {
      setSending(false);
    }
  };
        ...
        <div className="container my-3 p-5 bg-white rounded shadow-sm position-relative invoice-paper">
          ...
          <div className="position-relative z-1">
                ...
                <tbody className="invoice-detail-body">
                  {rows.map((r, idx) => (
                    <tr key={idx}>
                      ...
                      <td style={cellStyle}>
                        <span className="cell-2line">{r.armada_plat || "-"}</span>
                      </td>
                      <td style={cellStyle}>
                      ...
                      <td style={cellStyle}>
                        <span className="cell-2line">
                          {r.armada_end_date ? formatDate(r.armada_end_date) : "-"}
                        </span>
                      </td>
                      <td style={cellStyle}>
            ...
            <div className="text-dark mt-4 invoice-status">
              ...
              <p className="mb-0">
                <strong>Diterima oleh:</strong> {invoice.diterima_oleh || "-"}
              </p>
            </div>
